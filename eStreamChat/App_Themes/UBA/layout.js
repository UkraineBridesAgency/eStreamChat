function updateLayout() {
    ...
    if (messengerMode) {
        ...
        $(".messages").css('height', $(window).height() - $("#header").outerHeight() - $("#footer").outerHeight() - $("#tabs ul").outerHeight() - $('.member-profile').outerHeight() - 14);
        ...
        $("#messageInput").css('width', $("#footer").outerWidth() - $("#sendButton").outerWidth() - 50);
        $("#aside").css('height', $("#tabs:visible").outerHeight() - 0);
    }
